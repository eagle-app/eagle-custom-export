  ...
  <div class="settings-sidebar" ref="settingsContainerRef">
    ...
    <div class="settings-content" role="main">
      ...
      <QualitySettingsGroup 
        :settings-state="settingsState"
        :options="options"
        :dropdown-states="dropdownStates"
        :should-show-quality="shouldShowQuality"
        :should-show-fps="shouldShowFps"
        :update-setting="updateSetting"
        :update-dropdown-state="updateDropdownState"
      />
      ...
      <SizeSettingsGroup 
        ...
        :options="options"
        :dropdown-states="dropdownStates"
        :should-show-size-input="shouldShowSizeInput"
        :update-setting="updateSetting"
        :update-dropdown-state="updateDropdownState"
